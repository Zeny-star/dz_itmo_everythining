...
\begin{enumerate}
    \item $\displaystyle\int\limits_{1}^{\infty} x\left|\ln \cos \dfrac{1}{x}\right|\,\dl x$
    \item $\displaystyle\int\limits_{0}^{\infty}(e^x+x)\sin e^{2x}\, \dl x$
    \item $\displaystyle\int\limits_{0}^{1}(x-\sin x)^{-1} \dl x$
    \item $\displaystyle\int\limits_0^1 \dfrac{\sin(\pi/x)}{x(1-x)^{3/2}}\,\dl x$
\end{enumerate}
}
\sol
\begin{enumerate}
