...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{Prop}{Проблема}
{%
	enhanced,
	breakable,
	colback = mypropbg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter]{prop}{Проблема}
{%
	enhanced,
	breakable,
	colback = mypropbg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{claim}{Требование}
{%
	enhanced
	,breakable
	,colback = myg!10
...
\newtcbtheorem[number within=section]{Example}{Предметная область}
{%
	colback = myexamplebg
	,breakable
...
\newtcbtheorem[number within=section]{Definition}{Теоретическое введение}{enhanced,
